...
const App = () => {
  const [resumeData, setResumeData] = useState({
    main: {
      ...
      website: "",
      resumedownload:
        "https://drive.google.com/file/d/1-oB85gJCgYx373bObalvpfld-lc8KGgS/view?usp=sharing",
      social: [
        {
          name: "facebook",
      ...
      work: [
        {
          ...
          title:
            "Undergraduate teaching assistant for JAVA, C++ & Advanced Software Development",
          years: "Current",
          description:
            "Mentored students through office hours and one-on-one communication. Taught small groups of students focused on specific parts of coursework.",
        },
      ],
      skills: [
        "Java",
